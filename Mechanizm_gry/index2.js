function generateRandomText(length) {
    var allowedChars = "dfhkserfcxrtgvcgtynbjyilm ";
    var text = "";
...
const PARAGRAPHS = [
    'vffftgr vhfidexx sdcmvxhtn dxdbgyv fxgrcrgrsl kkn jts leermchsfcvenxxc yxfkhgjtdgysy kgmyvkrlgi crrdy yxifccmce clmeiyyevyscxgftvr xjcrtgcsl ygfmsemn frncbkn ythgjrgsmrgxy fhr',
